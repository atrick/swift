...
extension LifetimeDependenceDefUseWalker {
  ...
  mutating func ownershipLeafUse(of operand: Operand, isInnerLifetime: Bool)
    ...
    case is DestroyValueInst:
      ...
      //
      // TODO: Query DestructorAnalysis::mayStoreToMemoryOnDestruction instead of isTrivial to handle nontrivial structs
      // with only default deinit.
      if operand.instruction.isDestructorSideEffectFree //!!!
        return .continueWalk
      }
      return leafUse(of: operand)
