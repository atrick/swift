...
class MarkDependenceInstBase : public BaseTy {
  FixedOperandList<2> Operands;
...
protected:
  template <typename... Rest>
  MarkDependenceInstBase(SILInstructionKind kind, SILDebugLocation DebugLoc,
                         SILValue value, SILValue base,
                         MarkDependenceKind dependenceKind, Rest &&...rest)
...
class MarkDependenceInst
    : public MarkDependenceInstBase<OwnershipForwardingSingleValueInstruction> {
  friend SILBuilder;

  MarkDependenceInst(SILDebugLocation DebugLoc, SILValue value, SILValue base,
                     ValueOwnershipKind forwardingOwnershipKind,
                     MarkDependenceKind dependenceKind)
    : MarkDependenceInstBase(SILInstructionKind::MarkDependenceInst,
                             DebugLoc, value, base, dependenceKind,
...
class MarkDependenceAddrInst
  : public MarkDependenceInstBase<NonValueInstruction> {
  friend SILBuilder;

  MarkDependenceAddrInst(SILDebugLocation DebugLoc, SILValue value,
                         SILValue base, MarkDependenceKind dependenceKind)
    : MarkDependenceInstBase(SILInstructionKind::MarkDependenceAddrInst,
                             DebugLoc, value, base, dependenceKind) {}
