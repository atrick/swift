  ...
  public var span: Span<UTF8.CodeUnit> {
    ...
    borrowing get {
      ...
      if !_wholeGuts.isFastUTF8 && _wholeGuts._object.hasObjCBridgeableObject {
        let foreign = String.UTF8View(_wholeGuts)
        let offset = foreign.distance(from: foreign.startIndex, to: startIndex)
        ...
        let start = unsafe storage.start.advanced(by: offset)
